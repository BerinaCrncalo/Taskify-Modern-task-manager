...
fun DateTester(date1: Date, date2: Date): Color{
    val date1text = com.example.taskify_moderntaskmanager.ui.utils.DateFormatter(date1)
    val date2text = com.example.taskify_moderntaskmanager.ui.utils.DateFormatter(date2)
